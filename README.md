...
- [MailFathom](https://github.com/Krzysztof318/MailFathom) - Self-hosted AI brain for email that synchronizes IMAP mailboxes into PostgreSQL and provides lexical and semantic search, cited question answering, local-model support, and MCP access - `AGPL-3.0`, `C#/.NET 10`
